					...
					<form action="nouvellevente" method="POST">
						<table>
							<tr>
								...
								<td><input type="text" id="nom_article" name="nom_article"></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td><input type="url" id="image" name="image"></td>
							</tr>
							<tr>
								<td><label for="prix_initial">Mise à prix : </label></td>
								<td><input type="number" id="prix_initial" name="prix_initial" min="1" max="5000"></td>
							</tr>
							<tr>
								<td><label for="date_debut_encheres">Début de l'enchère : </label></td>
								<td><input type="date" id="date_debut_encheres" name="date_debut_encheres" min="${ dateDuJour }"></td>
							</tr>
							<tr>
								<td><label for="date_fin_encheres">Fin de l'enchère : </label></td>
								<td><input type="date" id="date_fin_encheres" name="date_fin_encheres" min="${ dateDuJour }"></td>
							</tr>
						</table>
						<fieldset>
    					...
    					<div class="row" id="boutonInscription">
							...
							<div class="col-12 col-lg-6"><div class="d-grid gap-2"><button type="button" class="btn btn-outline-danger"><a href="encheres">Annuler</a></button></div></div>
						</div>
					</form>
				</div>
			</div>
